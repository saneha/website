...
$sql = "SELECT * FROM decommissioning";
      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li class="current"><a href="decomissioning.php">Decommissioning</a></li>
...
<h1 align="center">Decommissioning Services Price of Remarkit</h1>
